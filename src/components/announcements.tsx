...
const announcements: Announcement[] = [
  {
    ...
    content:
      "We're excited to announce a field trip to study marine invertebrates. Permission slips are due by next Friday.",
    color: 'bg-blue-500',
  },
  {
  ...
  },
  {
    ...
    category: 'Students',
    content:
      "This week's challenge focuses on innovative ways to tackle ocean pollution. Get your thinking caps on!",
    color: 'bg-teal-500',
  },
  {
  ...
  return (
    <Card className="flex h-full flex-col shadow-lg">
      <CardHeader>
        ...
        <CardDescription>Latest news and updates for the KBE community.</CardDescription>
      </CardHeader>
            ...
            {announcements.map((item, index) => (
              <div key={index} className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">{item.content}</p>
                </div>
              </div>
            ))}
          </div>
