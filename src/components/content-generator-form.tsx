  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (type === 'program') {
        ...
        response = await generateWeeklyChallengeDescriptions(
          values as z.infer<typeof challengeSchema>
        );
      }
      setResult(response);
    } catch (error) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Provide details about the program, including target audience, activities, and
                    goals.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Enter a topic for the weekly challenge.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Target grade level for the challenge.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
