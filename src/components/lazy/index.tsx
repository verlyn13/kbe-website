...
export const LazyRegistrationFlow = createDynamicComponent(
  () => import('@/components/registration/registration-flow').then(mod => ({ default: mod.RegistrationFlow })),
  { 
...
export const LazyParentAccountForm = createDynamicComponent(
  () => import('@/components/registration/parent-account').then(mod => ({ default: mod.ParentAccountForm })),
  { 
...
export const LazyAddStudentsForm = createDynamicComponent(
  () => import('@/components/registration/add-students').then(mod => ({ default: mod.AddStudentsForm })),
  { 
...
export const LazySelectProgramForm = createDynamicComponent(
  () => import('@/components/registration/select-program').then(mod => ({ default: mod.SelectProgramForm })),
  { 
