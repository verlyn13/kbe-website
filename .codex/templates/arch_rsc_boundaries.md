Define server/client components, data-fetch layers, streaming, error boundaries, suspense, and cache keys. Include a proposed folder tree and 3 concrete refactors.
