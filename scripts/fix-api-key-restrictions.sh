...
echo "🔍 Diagnosing Firebase Auth API Blocking Issue"
echo "============================================="
echo ""

echo "Error: auth/requests-to-this-api-identitytoolkit-method-are-blocked"
echo "This means your Firebase API key has restrictions blocking homerenrichment.com"
echo ""
...
echo "     • https://kbe-website.web.app/*"
echo "     • http://localhost:*/*"
...
echo "2. Scroll to 'Your apps' → Web app"
...
echo "dig homerenrichment.com +short"
echo ""
echo "# Check SSL certificate"
echo "openssl s_client -connect homerenrichment.com:443 -servername homerenrichment.com < /dev/null 2>/dev/null | openssl x509 -noout -subject -issuer"
echo ""
...
echo "  -H 'Referer: https://homerenrichment.com' \\"
echo "  -d '{\"requestType\":\"EMAIL_SIGNIN\",\"email\":\"test@example.com\",\"continueUrl\":\"https://homerenrichment.com\"}'"
echo ""