...
echo "🔧 Fixing homerenrichment.com Issues"
echo "================================="
echo ""
...
echo "   • Ensure DNS records for homerenrichment.com are set to 'DNS only' (gray cloud)"
...
echo "   • Add: homerenrichment.com"
echo "   • Also add: www.homerenrichment.com (if using www)"
echo ""
...
echo "   • Enter: homerenrichment.com"
...
echo "   • Only the redirect URL needs to be homerenrichment.com"
echo ""
...
# Check DNS
echo "Checking DNS for homerenrichment.com:"
dig +short homerenrichment.com
echo ""

# Check if the domain responds
echo "Checking HTTPS response:"
curl -I https://homerenrichment.com 2>&1 | head -5
echo ""
