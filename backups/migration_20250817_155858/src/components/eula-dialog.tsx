        ...
        <ScrollArea className="h-[400px] pr-4">
          <div className="space-y-6 text-sm">
            <Alert className="border-destructive/50 bg-destructive/10">
              ...
              <AlertDescription>
                <p className="font-bold mb-2">CRITICAL NOTICE - THIS PROGRAM IS:</p>
                <ul className="space-y-1 ml-4">
                  <li>• <strong>NOT</strong> a Kenai Peninsula College program</li>
                  <li>• <strong>NOT</strong> a University of Alaska program</li>
                  <li>• <strong>NOT</strong> affiliated with any educational institution</li>
                  <li>• <strong>NOT</strong> affiliated with the school district or City of Homer</li>
                </ul>
              </AlertDescription>
            </Alert>

            <section>
              <h3 className="font-semibold mb-2">1. PROGRAM DESCRIPTION AND INDEPENDENCE</h3>
              <p className="mb-2">
                The Homer Enrichment Hub is a <strong>COMPLETELY INDEPENDENT ORGANIZATION</strong> providing 
                supplemental educational programs for students in the Homer, Alaska area.
              </p>
              <p className="mb-2">
                This program is organized by Jeffrey Johnson and Lia Calhoun acting in their 
                <strong> PERSONAL CAPACITIES</strong> as private individuals. While they are employed as 
                professors at Kenai Peninsula College, that employment is <strong>completely separate</strong> from 
                this program.
              </p>
            </section>

            <section>
              <h3 className="font-semibold mb-2">2. LIABILITY ACKNOWLEDGMENT</h3>
            ...
            <section>
              <h3 className="font-semibold mb-2">3. DATA PRIVACY</h3>
              <p className="mb-2">
                We collect only necessary information for program administration. Your data will not be 
                sold or shared with third parties. Records are not official school records and are not 
                subject to FERPA protections.
              </p>
            </section>
            ...
            <section>
              <h3 className="font-semibold mb-2">5. ACCOUNT REQUIREMENTS</h3>
              <p className="mb-2">
                You must be at least 18 years old to create an account. If registering a child, 
                you must be their parent or legal guardian. You agree to provide accurate information 
